    ...
    <td width="757" align="center" valign="top" bgcolor="#FFFFFF">       
      ...
      <tr>
        <td height="25" bgcolor="#EEEEEE">
        	<div align="center" style="color: #720206">收货人信息</div></td>
      </tr>
      <tr>
        <td height="295"><table width="530" height="293" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <form name="form1" method="post" action="../page/savedd.php" onSubmit="return chkinput(this)">
              ...
              <tr>
                ...
                <td height="25" colspan="3" bgcolor="#FFFFFF">
                	<div align="left">
                    <input onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" type="text" name="email" size="25" class="inputcss" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'">
                </div></td>
              </tr>
              <tr>
                <td height="25" bgcolor="#FFFFFF">
                	<div align="center">详细地址：</div></td>
                <td height="25" colspan="3" bgcolor="#FFFFFF">
                	<div align="left">
              ...
              <tr>
                ...
                <td height="86" colspan="3" bgcolor="#FFFFFF"><div align="left">
                    <textarea name="ly" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" cols="70" rows="5" class="inputcss" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'"></textarea>
                </div></td>
              </tr>
              <tr>
