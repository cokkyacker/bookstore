...
<div style="max-width:950px;margin:0 auto">
  ...
  <tr>
    ...
    <td width="781" align="center" valign="top" bgcolor="#FFFFFF"><table width="757" height="6" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td></td>
      </tr>
    </table>      
      <table width="730" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" bgcolor="#FFFFFF">&nbsp;&nbsp;商品信息</td>
        </tr>
      </table>
        <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
		   ...
		   ?>
				...
				{
			  ?>
                      <a href="<?php echo $info->tupian;?>" target="_blank"><img src="<?php echo $info->tupian;?>" alt="查看大图" width="180" height="180" border="0"></a>
                      <?php
			    }
			  ?>
                  </div></td>
                  <td width="92" height="20" align="left" bgcolor="#FFFFFF"><div align="center">商品名称：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->title;?></div></td>
                ...
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center">装订：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->bind;?></div></td>
                  <td width="100" bgcolor="#FFFFFF"><div align="center">出版社：</div></td>
                  <td width="129" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->publish;?></div></td>
                </tr>
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center">作者：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->anthor;?></div></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info->jianjie;?></div></td>
        ...
        <table width="730" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td>
            	<div align="right">
            		<a href="#" onclick="javascript:history.back(-1);" ><?php //echo $info->id;?>返回</a>&nbsp;&nbsp;
            		<a href="../page/addgouwuche.php?id=<?php echo $info->id;?>">放入购物车</a>&nbsp;&nbsp;
            	</div>
            </td>
          </tr>
        </table>
	  ...
	  ?>
  <form name="form1" method="post" action="../page/savepj.php?id=<?php echo $info->id;?>" onSubmit="return chkinput(this)">
  <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" bgcolor="#FFFFFF"><div align="center" style="color: #FFFFFF">
...
&nbsp;&nbsp;&nbsp;<a href="../page/showpl.php?id=<?php echo $_GET[id];?>">查看该商品评论</a></div></td>
            </tr>
          </table>
      </form>
    <?php
