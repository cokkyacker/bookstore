...
<form name="form1" method="post" action="chkadmin.php" onSubmit="return chkinput(this)">
  <table width="558" height="405"  background="images/di2.png" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
	<tr>
		<td width="194" >&nbsp;</td>
		<td width="364" ><table border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <td width="200" height="100" align="center">&nbsp;</td>
	      </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td align="center">
		    	<input name="imageField" type="image" src="images/login2.png"  border="0">
		    </td>
	      </tr>
	    </table>
	    </td>
