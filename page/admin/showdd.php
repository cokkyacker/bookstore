...
<table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr align="center" bgcolor="#FFCF60">
    <td height="20" colspan="2" bgcolor="#CCCC66">书籍订单</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="20" colspan="2">书籍列表(如下)：</td>
  </tr>
</table>
<table width="500" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#666666">
      ...
      <tr bgcolor="#CCCC66">
        <td width="153" height="20">书籍名称</td>
        <td width="80">市场价</td>
        <td width="80">会员价</td>
        <td width="80">数量</td>
        <td width="101">小计</td>
	  ...
	  ?>
	  <tr bgcolor="#FFFFFF">
        <td height="20"><?php echo $info1[title];?></td>
...
<table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20" colspan="4">
    	<span class="inputcssnull">汇款时注明您的订单号！汇款后请及时联系我们！</span>
    </td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
