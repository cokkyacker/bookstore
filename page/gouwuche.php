...
<table width="966" height="438" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="129" height="438" valign="top" bgcolor="#FFFFFF">
    ...
    <td width="761" align="center" valign="top" bgcolor="#FFFFFF">
      ...
      <table width="557" border="0" align="center" cellpadding="0" cellspacing="0">
        <form name="form1" method="post" action="../page/gouwuche.php">
          <tr>
          ...
          <tr>
			...
			?>
                <tr>
                  ...
                  <td height="25" bgcolor="#FFFFFF"><div align="center"><?php echo $num;?>
                  </div></td>
                  ...
                  <td height="25" colspan="8" bgcolor="#FFFFFF"><div align="right">
                      <table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="125"><div align="center"><a href="../page/gouwusuan.php">去结算</a></div></td>
                          <td width="125"><div align="center"><a href="../page/gouwuche.php?qk=yes">清空购物车</a></div></td>
