...
<div style="max-width:950px;margin:0 auto">
  ...
  <tr>
    <td width="109" height="438" valign="top" bgcolor="#FFFFFF"><div align="center">
...
//echo $row[0];
//}
//		 	 $sql=mysql_query("select id from tb_user where username='".$username."'",$conn);
//insert into tb_dingdan(userID) values('$id') 
//			$userID=$_GET[id];
//			
//		 ?>
      ...
      <table width="557" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
      		<td><button><a href="../page/gouwuche.php" style="color: #720206;">返回</a></button></td>
      	</tr>
      </table>
      <table width="530" border="0" align="center" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      	
      <tr>
        <td height="25" bgcolor="#FFFFFF"><div align="center" style="color: #720206">收货人信息</div></td>
      </tr>
      <tr>
        <td height="295"><table width="530" height="293" border="0" align="center" cellpadding="0" cellspacing="0">

            <form name="form1" method="post" action="../page/savedd.php" onSubmit="return chkinput(this)">
              <tr>
                <td width="100" height="25" bgcolor="#FFFFFF"><div align="center">收货人姓名：</div></td>
                <td width="183" bgcolor="#FFFFFF">
                	<div align="left">
                    <input onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" type="text" name="name2" size="25" class="inputcss" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'">
                </div></td>
              ...
              <tr>
                ...
                <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                    <input onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" name="dz" type="text" class="inputcss" id="dz" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'" size="50">
                </div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="86" colspan="3" bgcolor="#FFFFFF"><div align="left">
                    <textarea onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" name="ly" cols="70" rows="5" class="inputcss" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'"></textarea>
                </div></td>
              </tr>
              <tr>
...
<?php
 if($_GET[dingdanhao]!="")
  {  $dd=$_GET[dingdanhao];
	...
	echo" window.open('../page/showdd.php?dd='+'".$dd."','newframe','top=150,left=200,width=600,height=".$sum.",menubar=no,toolbar=no,location=no,scrollbars=no,status=no ')";
	echo "</script>";
