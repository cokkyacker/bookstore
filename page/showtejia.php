        ...
        <tr>
            ...
            <td width="781" align="center" valign="top" bgcolor="#FFFFFF">
                <table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="50" >&nbsp;<img class="imga" src="../img/sp2.png" width="22" height="22">&nbsp;<span class="fb">特价书籍：</span> </td>
                    </tr>
                </table>
                ...
                <?php
                $sql=mysql_query("select count(*) as total from tb_book where tejia=1 ",$conn);
                ...
                else
                {
                    ...
                    <table width="750" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        $sql1=mysql_query("select * from tb_book where tejia=1 order by addtime desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
                    ...
                    <table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><div align="right">本站共有推荐产品&nbsp;
                                    ...
                                    {
                                        ?>
                                        <a href="../page/showtejia.php?page=1" title="首页"><font face="webdings"> 9 </font></a> <a href="../page/showtejia.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
                                        <?php
                                    }
                                    if($pagecount<=4){
                                        for($i=1;$i<=$pagecount;$i++){
                                            ?>
                                            <a href="../page/showtejia.php?page=<?php echo $i;?>"><?php echo $i;?></a>
                                            <?php
                                        }
                                    }else{
                                        for($i=1;$i<=4;$i++){
                                            ...
                                            <a href="../page/showtejia.php?page=<?php echo $i;?>"><?php echo $i;?></a>
                                        <?php }?>
                                        <a href="../page/showtejia.php?page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a> <a href="../page/showtejia.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
                                    <?php }?>
                                </div></td>
                        </tr>
                    </table>
