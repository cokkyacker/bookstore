...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="306" bgcolor="#FFFFFF"><table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="left" class="style5">&nbsp;书籍列表(如下)：</div></td>
      </tr>
    </table>
      <table width="500" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="#666666"><table width="500" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr bgcolor="#F0F0F0">
                <td width="153" height="20"><div align="center" class="style7">书籍名称</div></td>
	  ...
	  for($i=0;$i<count($arraysp);$i++){
		 if($arraysp[$i]!=""){
	     $sql1=mysql_query("select * from tb_book where id='".$arraysp[$i]."'",$conn);
	     $info1=mysql_fetch_array($sql1);
		 $total=$total+=$arraysl[$i]*$info1[huiyuanjia];
	  ?>
              <tr bgcolor="#FFFFFF">
                <td height="20"><div align="center"><?php echo $info1[title];?></div></td>
	 ...
	 ?>
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#FFFFFF">
          <td height="20" colspan="4"><div align="left" class="style6">感谢您使用网上书店购物</div></td>
        </tr>
        <tr bgcolor="#FFFFFF">
          <td height="20">&nbsp;</td>
